...
import { SiteFormElementsSidebar, SiteFormElementsTree } from './components';
...
const SiteFormBuilderStep2 = observer((props: Props) => {
...
SiteFormBuilderStep2.displayName = 'SiteFormBuilderStep2';
export { SiteFormBuilderStep2 };
