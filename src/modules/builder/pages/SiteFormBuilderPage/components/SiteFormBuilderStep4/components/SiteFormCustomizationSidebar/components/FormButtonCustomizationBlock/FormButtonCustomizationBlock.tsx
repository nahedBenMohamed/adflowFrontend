...
import {
  ...
  SiteFormBorder,
  SiteFormFontSize,
  type SiteFormButtonDesignFormData,
} from '../../../../../../../../shared';
...
interface Props {
  buttonDesignFormData: SiteFormButtonDesignFormData;
}

const FormButtonCustomizationBlock = observer((props: Props) => {
  const { buttonDesignFormData } = props;

  const { t } = useTranslation('module.builder', {
    keyPrefix:
      'builder.pages.site_form_builder_page.site_form_builder_step4.sidebar.form_button_customization_block',
  });
...
FormButtonCustomizationBlock.displayName = 'FormButtonCustomizationBlock';
export { FormButtonCustomizationBlock };
